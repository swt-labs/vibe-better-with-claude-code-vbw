...
- For codebase mapping tasks, code-analysis MCP tools (architecture extraction, dependency graphs, call hierarchy, symbol search) should be preferred over brute-force Glob/Read/Grep when available — they produce more accurate structural data in fewer calls.
