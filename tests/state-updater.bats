...
@test "remediation round-dir in-progress UAT write keeps ROADMAP unchecked" {
  cd "$TEST_TEMP_DIR"
...
EOF
  ...
  printf '%s\n' '---' 'status: in_progress' '---' 'Round still verifying.' > .vbw-planning/phases/01-setup/remediation/uat/round-06/R06-UAT.md
